...
pub fn build(b: *std.Build) !void {
    ...
    //const arg_sysroot = "emsdk/upstream/emscripten/cache/sysroot";

    const include_path = "emsdk/upstream/emscripten/cache/sysroot/include/";
    ...
    lib.addSystemIncludePath(b.path(include_path)); // isystem
    ...
    emcc_cmd.addArgs(&[_][]const u8{ "-o", b.fmt("zig-out/www/index.html", .{}), "-Oz", "--shell-file=shell.html", "-sASYNCIFY", "-sUSE_WEBGPU=1" });
    emcc_cmd.step.dependOn(&lib.step);
    emcc_cmd.step.dependOn(&mkdir.step);
